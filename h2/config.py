...
class H2Configuration(object):
    ...
    """
    client_side = _BooleanConfigOption('client_side', default=True)
    validate_outbound_headers = _BooleanConfigOption(
        'validate_outbound_headers', default=True
    )
    normalize_outbound_headers = _BooleanConfigOption(
        'normalize_outbound_headers', default=True
    )
    validate_inbound_headers = _BooleanConfigOption(
        'validate_inbound_headers', default=True
    )
